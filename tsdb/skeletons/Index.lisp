...
((:path . "test_corpus") (:content . "Test corpus from real world."))
((:path . "test_suite_lab5") (:content . "Test suite collected for Lab 5."))
((:path . "testcorpus") (:content . "Test corpus gathered from sealang.net"))
